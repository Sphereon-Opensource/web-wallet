import {createAgent, DIDDocument, IAgentContext, IAgentPlugin, ProofFormat, TAgent, W3CVerifiableCredential} from '@veramo/core'
import {
...
OID4VCIRestAPI.init({
  ...
  credentialDataSupplier: async (args: CredentialDataSupplierArgs): Promise<CredentialDataSupplierResult> => {
    ...
    return {
      credential: CredentialMapper.toUniformCredential(credential),
