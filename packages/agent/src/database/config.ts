...
import { DataStoreStatusListEntities } from "@sphereon/ssi-sdk.data-store";
import { DataStoreStatusListMigrations } from "@sphereon/ssi-sdk.data-store/dist/migrations/generic";
...
const postgresConfig: PostgresConnectionOptions = {
  ...
  entities: [...VeramoDataStoreEntities, ...DataStoreStatusListEntities],
  migrations: [...VeramoDataStoreMigrations, ...DataStoreStatusListMigrations],
