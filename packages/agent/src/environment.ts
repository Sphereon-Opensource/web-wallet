...
export const CONF_PATH = env("CONF_PATH", ENV_VAR_PREFIX)
  ...
  : resolve("../../conf");
export const OID4VCI_API_BASE_URL =
  env("OID4VCI_API_BASE_URL", ENV_VAR_PREFIX) ?? "/oid4vci";
...
export const CONTACT_MANAGER_API_FEATURES: ContactManagerMRestApiFeatures[] =
  env("CONTACT_MANAGER_API_FEATURES", ENV_VAR_PREFIX)
    ? (env("CONTACT_MANAGER_API_FEATURES", ENV_VAR_PREFIX)?.split(
        ",",
      ) as ContactManagerMRestApiFeatures[])
...
export const STATUS_LIST_ID =
  ...
  "http://localhost/vc/credentials/status-lists/1";
