...
const ImportFileModal: FC<Props> = (props: Props): ReactElement => {
  const {headerTitle, headerSubTitle, dragBoxCaption, dragBoxDescription, onImportFile, onValidateFile, validationMessage, onClose} = props
    ...
    <div className={style.overlay} onClick={onClose}>
      <div className={style.container} onClick={(event: React.MouseEvent<HTMLDivElement, MouseEvent>) => event.stopPropagation()}>
        ...
        <div className={style.contentContainer}>
          <DragAndDropBox caption={dragBoxCaption} description={dragBoxDescription} onChangeFile={onChangeFile} />
