...
const CredentialDesignerVisualDesignEditContent: FC = (): ReactElement => {
  const translate = useTranslate()
  const {isAdvancedMode, onModeChange, credentialDesignerVisualDesignFormData, onCredentialDesignerVisualDesignFormDataChange} =
...
export default CredentialDesignerVisualDesignEditContent
