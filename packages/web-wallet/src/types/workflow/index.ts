...
export const getProcessOwnerDid = () =>
  getEnv('BROWSER_PUBLIC_getProcessOwnerDid()') ??
...
export const getSupplierDid = () => getEnv('BROWSER_PUBLIC_getSupplierDid()') ?? 'did:web:localhost:stonebase'

export const getTesterDid = () => getEnv('BROWSER_PUBLIC_getTesterDid()') ?? 'did:web:localhost:sgs'
