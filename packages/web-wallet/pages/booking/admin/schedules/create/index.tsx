...
const ScheduleSetCreatePage: FC = (): ReactElement => {
  ...
  const {mutate: createScheduleSet, isLoading: isCreating} = useCreate()
  ...
  const getButtonCaption = (): string => {
    if (step === maxSteps) {
      return isCreating ? 'Creating...' : 'Create Schedule'
    }
  ...
  return (
    <div className={style.container}>
      <PageHeaderBar path="Booking / Admin / Schedules / Create" />
          ...
          <div className={style.formCard}>
            ...
            {step === 1 && (
              <FormSection
                ...
                description="Enter the name and description for this schedule."
              >
                <FormRow columns={1}>
                  <FormInput
                    label="Schedule Name"
            ...
            {step === 2 && (
              <FormSection
                ...
                description="Define the time rules for this schedule."
              >
                {/* Existing Rules */}
            ...
            {step === 4 && (
              <>
                <h2>Review & Create</h2>
                <p className={style.stepDescription}>Review the schedule details before creating.</p>
...
export default ScheduleSetCreatePage
